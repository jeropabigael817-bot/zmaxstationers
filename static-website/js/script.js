...
if (pathName.includes('products.html')) {
  ...
  if (tabParam && ['home', 'services', 'about'].includes(tabParam)) {
    currentTab = tabParam;
  }
}
...
function initApp() {
  ...
  // Pre-fill search inputs if searchQuery is initialized from URL
  if (searchQuery) {
...
function switchTab(tabId) {
  ...
  if (tabId === 'shop') {
    if (!window.location.pathname.includes('products.html')) {
      ...
      window.location.href = 'products.html' + paramsStr;
      return;
    }
